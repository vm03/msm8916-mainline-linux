...
uint32_t hypervisor_cpuid_base(const char *sig, uint32_t leaves)
{
...
EXPORT_SYMBOL_GPL(hypervisor_cpuid_base);
...
EXPORT_SYMBOL_GPL(get_debugctlmsr);
...
EXPORT_SYMBOL_GPL(update_debugctlmsr);
